...
<main>
  ...
  <section id="about">
    <?php
    $nim = "2522500074";
    $Nama_Lengkap = " Engrasia Masyithah";
    $Tempat_Lahir = "Sungailiat";
    $Tanggal_Lahir = "24 Maret 2007";
    $hobi = "Make up &#127926;";
    $Pasangan = "Belum ada &hearts;";
    $Pekerjaan = "Mahasiswa &copy; 2025";
    $Nama_orang_tua ="Bapak Edy Ridwan dan Ibu Linda Kartini";
    $Nama_kakak = "Tidak ada";
    $Nama_adik = "Jihan Nadhifah";
    ?>
    <h2>&hearts;TENTANG SAYA&hearts;</h2>
